...
### 一、禁止访问注册网站
&emsp;&emsp;打开hosts文件  
- **windows**:`C:\Windows\System32\drivers\etc`下的hosts文件，使用notepad++等工具进行编辑  
...
```
### 二、启动idea并激活
![](https://imgsa.baidu.com/exp/w=500/sign=5dcf7e36f61f4134e037057e151d95c1/80cb39dbb6fd52662bc7dfc1a018972bd5073673.jpg)  
添加以下激活码：  
```jshelllanguage
...
若无法激活，可尝试[此方法](http://idea.lanyus.com/)或百度其它教程